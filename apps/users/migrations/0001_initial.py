    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number_confirmation_token', models.CharField(editable=False, max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('currency', models.CharField(choices=[('sms', 'sms notification'), ('app', 'Application Notification'), ('bh', 'both types')], default='app', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Brand')),
